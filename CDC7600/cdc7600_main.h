...
Instruction program1[] = {
    ...
    Instruction("Form x^2", Instruction::MULF, Instruction::x0, Instruction::x1,
        Instruction::x1),
    ...
    Instruction("Form Y", Instruction::ADDF, Instruction::x7, Instruction::x6,
        Instruction::x3),
...
Instruction program2[] = {
    ...
    Instruction("Form BX", Instruction::MULF, Instruction::x3, Instruction::x1,
        Instruction::x1),
    Instruction("Form AX^2 + BX", Instruction::ADDF, Instruction::x5,
        Instruction::x6, Instruction::x3),
    Instruction("Form Y", Instruction::ADDF, Instruction::x7, Instruction::x5,
        Instruction::x4),
