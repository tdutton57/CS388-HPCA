...
Instruction program1[] = {
    Instruction("Fetch x", Instruction::INC, Instruction::a1, Instruction::a1, 42),
    Instruction("Fetch A", Instruction::INC, Instruction::a2, Instruction::a2, 43),
    ...
    Instruction("Fetch B", Instruction::INC, Instruction::a3, Instruction::a3, 44),
    Instruction("Form Y", Instruction::ADDF, Instruction::x7, Instruction::x6, Instruction::x3),
    Instruction("Store Y", Instruction::INC, Instruction::a7, Instruction::a7, 45) };
...
Instruction program2[] = {
    Instruction("Fetch x", Instruction::INC, Instruction::a1, Instruction::a1, 1),
    Instruction("Fetch A", Instruction::INC, Instruction::a2, Instruction::a2, 2),
    Instruction("Form x^2", Instruction::MULF, Instruction::x0, Instruction::x1, Instruction::x1),
    Instruction("Form Ax^2", Instruction::MULF, Instruction::x6, Instruction::x0, Instruction::x2),
    Instruction("Fetch B", Instruction::INC, Instruction::a3, Instruction::a3, 3),
    Instruction("Fetch C", Instruction::INC, Instruction::a4, Instruction::a4, 4),
    Instruction("Form BX", Instruction::MULF, Instruction::x3, Instruction::x3, Instruction::x1),
    ...
    Instruction("Store Y", Instruction::INC, Instruction::a7, Instruction::a7, 5) };
